...
execute if entity @s[advancements={minecraft:adventure/throw_trident=true}] run scoreboard players add @s HCH_Temp_Count 1
...
execute if entity @s[advancements={minecraft:adventure/very_very_frightening=true}] run scoreboard players add @s HCH_Temp_Count 1
